...
$parameters = array (
 ...
 'FeedSubmissionId' => '<Feed Submission Id>', // TODO: Add Feed Submission ID from SubmitFeed Response
 'FeedSubmissionResult' => @fopen( WOO_AMZ_RESPONSE_LOG, 'rw+' ),
...
/**
  ...
  */
function invokeGetFeedSubmissionResult($service, $request) 
{
    try {
