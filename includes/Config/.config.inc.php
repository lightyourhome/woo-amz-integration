<?php
    ...
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAJMMLBT4DGU7GN2YQ');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'WooCommerce Amazon Integration');
    ...
    * marketplace ID.
    ***********************************************************************/
    define('MERCHANT_ID', 'A29F4PACYXDGU1');
    ...
    ***********************************************************************/   
    set_include_path( WOO_AMZ_PLUGIN_DIR . 'includes' );
